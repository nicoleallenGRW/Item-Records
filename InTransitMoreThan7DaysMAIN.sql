...
WHERE 
 ...
 (bib_view.id = bib_record_item_record_link.bib_record_id 
  ...
  AND item_view.checkin_statistics_group_code_num between 900 and 999
  ...
  and varfield_view.varfield_type_code = 'm'
  and item_status_code = 't' 
  AND item_view.location_code like '%g%'
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
 ...
 or
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%931%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%932%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%935%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
...
or
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%933%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%941%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
  ...
  AND varfield_view.record_id = item_view.id 
  and varfield_view.varfield_type_code = 'm'
  and varfield_view.varfield_type_code like '%920%'
  and item_status_code = 't' 
  AND item_record_property.item_record_id = item_view.id 
  AND 
  ((record_metadata.record_last_updated_gmt::date - current_date)between -100 and -7)) and item_view.location_code != 'gmill'
